  ...
  return (
    <>
      ...
      <main className='relative'>
        ...
        Bienvenidos
                  ...
                  <div>
                    ...
                    <p className='font-sans mb-8 leading-relaxed italic text-xl'>
                      De la cobardía que no se atreve a enfrentar nuevas
                      verdades,
                      <br />
        ...
        <Container>
          <div className="px-64 mb-32 text-gray-900 text-3xl">
            <h3 className="text-center">Encuentre variedad de artículos escritos por el teólogo Juan Stam y otros autores invitados.</h3>
          </div>
